...
<PARA>
This is version &specversion; of the LSB-Python Module Specification.
This version is a preliminary version for review only. Conclusion of work on
this version will result in version 4.1 of the LSB-Python Module Specification.
...
to be an implementation of LSB-Python Module unless it has successfully
...
<PARA>
The LSB-Python Module defines the Python components that are required to
...
<TITLE>Scope</TITLE>
<PARA>
The LSB Python defines the Python components found on an LSB conforming
system.
</PARA>
</CHAPTER>
...
the LSB-Python Module Standard.  Such references may be normative or
informative; a reference to specification shall only be considered
normative if it is explicitly cited as such.  The LSB-Python Module
...
<PARA>
This specification describes a Python interpreter which shall
...
-->
<!--
<SECT1 ID="Application"><TITLE>LSB-Python Module Conformance</TITLE>
<PARA>
