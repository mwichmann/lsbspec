...
include(groupdel.sgml)
include(groupmod.sgml)
include(groups.sgml)
include(gzip.sgml)
include(gunzip.sgml)
include(head.sgml)
include(hostname.sgml)
include(iconv.sgml)
include(install.sgml)
include(ipcrm.sgml)
include(ipcs.sgml)
include(killall.sgml)
include(ln.sgml)
include(localedef.sgml)
include(login.sgml)
include(lpr.sgml)
include(ls.sgml)
include(lsbrelease.sgml)
include(m4.sgml)
include(make.sgml)
include(man.sgml)
include(md5sum.sgml)
...
include(umount.sgml)
include(uname.sgml)
include(unexpand.sgml)
include(uniq.sgml)
include(useradd.sgml)
include(userdel.sgml)
