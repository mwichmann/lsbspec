...
Locale definitions shall support the locale categories defined in the
FDCC-set of <XREF LINKEND="STD.TR14652">, and may also support the
<envar>LC_PAPER</envar> and <envar>LC_MEASUREMENT</envar> categories
mentioned in annex D of that specification.
</para>
</section>
