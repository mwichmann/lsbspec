...
<PARA>
This is version &specversion; of the LSB-Graphics-Ext Module Specification.
This version is a preliminary version for review only. Conclusion of work on
this version will result in version 4.1 of the LSB-Graphics-Ext Module
Specification.
...
to be an implementation of LSB-Graphics-Ext Module unless it has successfully
...
<PARA>
The LSB-Graphics-Ext Module defines the additional graphics components 
that are required to be present on a conforming system and are not part of existing Graphics module specification.
</PARA>
...
<TITLE>Scope</TITLE>
<PARA>
The LSB Graphics-Ext defines the add-on graphical interface found on an LSB conforming
system.
</PARA>
</CHAPTER>
...
the LSB-Graphics-Ext Module Standard.  Such references may be normative or
informative; a reference to specification shall only be considered
normative if it is explicitly cited as such.  The LSB-Graphics-Ext Module
...
<PARA>
The libraries listed in <XREF LINKEND='tbl-graphics-ext-stdlib'> shall
...
<TABLE ID=tbl-graphics-ext-stdlib>
