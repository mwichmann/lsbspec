...
this version will result in version 3.1 of the LSB-Toolkit-Qt3 Module
Specification.
</PARA>
<PARA>
...
<PARA>
The LSB-Toolkit-Qt3 Module defines the Qt3 toolkit components that are required to
...
<TITLE>Scope</TITLE>
<PARA>
The LSB Toolkit-Qt3 defines the Qt3 Application framework libraries 
...
the LSB-Toolkit-Qt3 Module Standard.  Such references may be normative or
informative; a reference to specification shall only be considered
normative if it is explicitly cited as such.  The LSB-Toolkit-Qt3 Module
...
<PARA>
The libraries listed in <XREF LINKEND='tbl-toolkit-qt3-stdlib'> shall
...
<TABLE ID=tbl-toolkit-qt3-stdlib>
