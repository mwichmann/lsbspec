...
<PARA>
This is version &specversion; of the LSB-Perl Module Specification.
This version is a preliminary version for review only. Conclusion of work on
this version will result in version 4.1 of the LSB-Perl Module Specification.
...
to be an implementation of LSB-Perl Module unless it has successfully
...
<PARA>
The LSB-Perl Module defines the Perl components that are required to
...
<TITLE>Scope</TITLE>
<PARA>
The LSB Perl Module defines the Perl components found on an LSB conforming
system.
</PARA>
</CHAPTER>
...
the LSB-Perl Module Standard.  Such references may be normative or
informative; a reference to specification shall only be considered
normative if it is explicitly cited as such.  The LSB-Perl Module
...
<PARA>
This specification describes a Perl interpreter which shall
...
-->
<!--
<SECT1 ID="Application"><TITLE>LSB-Perl Module Conformance</TITLE>
<PARA>
