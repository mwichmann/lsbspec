...
this version will result in version &targetversion; of the LSB-Multimedia 
...
to be an implementation of LSB-Multimedia Module unless it has successfully
...
<PARA>
The LSB-Multimedia Module defines the multimedia components that are required to
...
<TITLE>Scope</TITLE>
<PARA>
The LSB-Multimedia module defines the multimedia components found on an
...
the LSB-Multimedia Module Standard.  Such references may be normative or
informative; a reference to specification shall only be considered
normative if it is explicitly cited as such.  The LSB-Multimedia Module
