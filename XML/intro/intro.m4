...
<PARA>
This is version &specversion; of the LSB-XML Module Specification.
This version is a preliminary version for review only. Conclusion of work on
this version will result in version &targetversion; of the LSB-XML Module
Specification.
</PARA>
<PARA>
...
<PARA>
The LSB-XML Module defines the XML components that are required to
...
<TITLE>Scope</TITLE>
<PARA>
The LSB XML defines the XML components found on an LSB conforming
system.
</PARA>
</CHAPTER>
...
the LSB-XML Module Standard.  Such references may be normative or
informative; a reference to specification shall only be considered
normative if it is explicitly cited as such.  The LSB-XML Module
